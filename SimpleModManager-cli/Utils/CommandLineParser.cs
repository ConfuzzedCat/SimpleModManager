...
public static class CommandLineParser
{
    public static Dictionary<string, string> ParseArguments(string[] args)
    {
        ...
        if (args.Length > 2) throw new ArgumentException("Too many arguments provided");
        ...
        switch (str)
        {
            ...
            case "--game":
            {
                ...
                if (value.StartsWith('-')) throw new ArgumentException("Expected a value after '-g' or '--game'");
